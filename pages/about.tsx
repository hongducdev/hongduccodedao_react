...
const about = () => {
  return (
    <>
      <Head>
        <title>About me | hongduccodedao</title>
        <meta name="title" content="About me | hongduccodedao"></meta>
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="About me | hongduccodedao" />
        <meta
        ...
        <meta property="twitter:title" content="About me | hongduccodedao" />
        <meta
